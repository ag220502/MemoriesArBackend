...
const loginFunc = async (req,res)=>{
    ...
    res.cookie("accessToken", token).status(200).json({token:token,userId:data[0].id})
}
...
module.exports = {loginFunc,registerFunc,logoutFunc,forgotFunc, updatePassword,getId}